<template>
  <button
    class="group !text-primary flex items-center justify-center relative z-10 transition-all duration-500 ease-in-out rounded-md p-[5px] cursor-pointer border border-[#999] outline-none focus-visible:outline-0"
  >
    <svg
      fill="currentColor"
      stroke="none"
      ...
      class="w-7 h-7 overflow-visible transition-transform duration-300 ease-in-out group-hover:rotate-45 [&>path]:transition-transform [&>path]:duration-[350ms] [&>path]:ease-in-out"
    >
      <path
